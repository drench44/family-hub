#!/usr/bin/env python3
"""Cut a family-hub release — the whole ceremony, atomically.
...
INDEX_HTML = REPO_ROOT / "src" / "family_hub" / "web" / "static" / "index.html"
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Cut a family-hub release.")
